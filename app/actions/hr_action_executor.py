...
class HRActionExecutor:
    ...
    async def _handle_leave(
        ...
        employee_email  = payload.get("employee_email", f"employee_{payload.get('employee_id')}@company.com")
...
_executor_instance: Optional[HRActionExecutor] = None
