...
import { Hexagon, MessageSquare, Globe, Mail, PhoneCall, Send } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-slate-500 text-xs text-center">
          ...
          <div className="flex items-center gap-4">
            <a href="#" onClick={(e) => e.preventDefault()} className="hover:text-slate-900 hover:bg-slate-50 p-2 rounded-lg bg-white border border-slate-200 shadow-sm transition-colors" aria-label="Send message link">
              <Send className="w-4 h-4" />
            </a>
            <a href="#" onClick={(e) => e.preventDefault()} className="hover:text-slate-900 hover:bg-slate-50 p-2 rounded-lg bg-white border border-slate-200 shadow-sm transition-colors" aria-label="Message board link">
