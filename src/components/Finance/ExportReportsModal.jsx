    ...
    <div className={`${s.exportCard} ${isDone ? s.exportCardDone : ""}`}>
      ...
      >
        {isLoading ? (
          ...
          <>
            <CheckCircle2 className={s.inlineIcon} aria-hidden="true" />
            Downloaded
          </>
        ) : (
          <>
            <Download className={s.inlineIcon} aria-hidden="true" />
            {format.toUpperCase()}
          </>
        )}
      </button>
      ...
      <div className={s.modal}>
        ...
        <div className={s.modalHeader}>
          <div className={s.modalTitleRow}>
            <span className={s.modalTitleIcon} aria-hidden="true">
              <Download className={s.iconSvg} />
            </span>
            <div>
          ...
          <button className={s.closeBtn} onClick={onClose} aria-label="Close export modal">
        ...
        <div className={s.modalFooter}>
          <p className={s.footerNote}>
            <FolderOpen className={s.inlineIcon} aria-hidden="true" /> Files are saved to your default Downloads folder.
          </p>
