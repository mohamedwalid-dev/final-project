        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-2.5 max-h-[640px] overflow-y-auto pr-2 scrollbar-thin">
            {erpModules.map((module) => {
              const LucideIcon = Icons[module.iconName] || Icons.HelpCircle;
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-3 px-4 py-3.5 rounded-2xl text-left border cursor-pointer transition-all duration-300 ${isSelected
