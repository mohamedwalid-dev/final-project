...
export default function AISection() {
  const [activeTask, setActiveTask] = useState("forecast");
                ...
                {tasks.map((task) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-2 px-3 py-2 rounded-xl text-[11px] font-semibold text-left transition-all border cursor-pointer ${activeTask === task.id
                  ...
                  {isProcessing ? (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        {taskResult.metrics.map((m: any, i) => (
